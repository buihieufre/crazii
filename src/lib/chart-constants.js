...
export const BEARISH_COLOR = '#fe0000'; // Red (Crazii Bearish)
...
export const PRICE_LINE_SPECS = [
  ...
  { key: 'ktr_plus_3', title: 'KTR+3', color: '#FFEB3B', bgColor: '#FFEB3B', textColor: '#000000', lineStyle: 2 },
  ...
  { key: 'ktr_minus_1', title: 'KTR-1', color: '#00E676', bgColor: '#00E676', textColor: '#000000', lineStyle: 2 },
  { key: 'ktr_minus_2', title: 'KTR-2', color: '#FFEB3B', bgColor: '#FFEB3B', textColor: '#000000', lineStyle: 2 },
  { key: 'ktf_minus_3', altKey: 'ktr_minus_3', title: 'KTR-3', color: '#FF9800', bgColor: '#FFB74D', textColor: '#000000', lineStyle: 2 },
